...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
		//waitForElementPresence(locator,10);// Its like a global wait
	...
	/**
	 * 
	 * This method will return list of attribute values
	 * 
	 * @param locator
	 * @param value
	 * @param attrName
	...
	public List<String> getElementsAttributesList(By locator, String value, String attrName) {
	...
	/**
	 * This method will be for any list of footers
	 * 
	 * @param locator
	 * @param linkText
	 */
	...
	/**
	 * This method will return the list of options available in drop down
	 * @param locator
	 * @return
	 */
	...
	public WebElement waitForElementVisible(By locator , int timeOut ,int pollingTime) {
		WebDriverWait wait=new 
				WebDriverWait(driver,Duration.ofSeconds(timeOut), Duration.ofSeconds(pollingTime));
		return wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
	}
	...
	public void sendKeysAlert(int timeOut, String text) {
	...
	public WebElement waitForElementPresenceWithFluentWait(By locator, int timeOut, int PollingTime) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
				...
				.withMessage(locator+" is not found within the given time duration....");
